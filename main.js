...
var playState = {
    preload: function () {
    	...
    	game.load.spritesheet('pointBarIcon', '/game-assets/point_hit_all.png',72,72);

    	game.load.image('hiteAreaMask', '/game-assets/area_click_mask.png');
    	game.load.image('flower', '/game-assets/flower.png');
    	game.load.image('flower2', '/game-assets/flower2.png');
    	game.load.image('iconLeft', '/game-assets/icon_left_fly.png');
    	game.load.image('good', '/game-assets/good.png');
